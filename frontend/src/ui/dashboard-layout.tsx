  ...
  return (
    <div className="bg-background text-foreground min-h-screen">
      <div className="mx-auto flex min-h-screen max-w-[1440px] overflow-x-clip">
        <aside className="border-border/70 bg-sidebar/70 hidden w-72 flex-col border-r px-5 py-6 md:flex lg:w-80 lg:px-6 lg:py-7">
          <div>
          ...
          <div className="border-border bg-background/90 sticky top-0 z-20 border-b px-4 py-3 backdrop-blur md:hidden">
            ...
            {mobileNavOpen ? (
              <div
                ...
                className="dashboard-enter mt-4 space-y-2"
              >
