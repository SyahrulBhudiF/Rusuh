...
cargo clippy                   # lint
cargo test                     # all tests (54 tests across 6 files)
...
│   ├── manager.rs       # AccountManager — loads/reloads auth records
│   ├── store.rs         # FileTokenStore — reads auth files from disk
...
│   ├── antigravity.rs   # AntigravityProvider — Gemini API via Vertex AI
